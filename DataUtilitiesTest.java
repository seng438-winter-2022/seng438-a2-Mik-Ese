...
public class DataUtilitiesTest{
	...
	@Test
    public void calculateColumnTotalNegCol(){
        mockClass.checking(new Expectations(){ {
            one(table).getRowCount();
            will(returnValue(1));
        ...
        assertEquals("calculateColumnTotal should return 0.0", DataUtilities.calculateColumnTotal(table, -1),
                1.0, 0.000000001d);
    }

	@Test
    public void calculateColumnTotalColOutOfBounds(){
        mockClass.checking(new Expectations(){ {
            one(table).getRowCount();
            will(returnValue(1));
        ...
        assertEquals("calculateColumnTotal should return 0.0", DataUtilities.calculateColumnTotal(table, 5),
                1.0, 0.000000001d);
    }
	...
	@Test
    public void calculateRowTotalNegRow(){
        mockClass.checking(new Expectations(){ {
            one(table).getRowCount();
            will(returnValue(1));
        ...
        assertEquals("calculateColumnTotal should return 0.0", DataUtilities.calculateRowTotal(table, -1),
                1.0, 0.000000001d);
    }

	@Test
    public void calculateRowTotalRowOutOfBounds(){
        mockClass.checking(new Expectations(){ {
            one(table).getRowCount();
            will(returnValue(1));
        ...
        assertEquals("calculateColumnTotal should return 0.0", DataUtilities.calculateRowTotal(table, 5),
                1.0, 0.000000001d);
    }
